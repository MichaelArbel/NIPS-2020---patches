...
%  Then, for the linear experiments and 1-hidden layer experiments, we used respectively $k_2=1, c_2=128$ and  $ k_2=3,c_2=1024$ because we observed it lead to better performances.
% Our data augmentation consists in horizontal random flips and random crops of size $32^2$ after  reflect-padding with $4$ pixels. For the representation, we used $K=0.4 |\mathcal{D}|$, which implies that our representation is not sparse.
