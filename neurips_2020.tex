...
\begin{figure}[h]
\centering
\subfloat[Subfigure 1 list of figures text][ImageNet (128x128)]{
  	\includegraphics[width=.6\linewidth]{figures/topographical_order_more_patches_imagenet128_patches_12}
\label{fig:subfig1}}
\qquad
\subfloat[Subfigure 2 list of figures text][ImageNet (64x64)]{
  	  	\includegraphics[width=0.3\linewidth]{figures/topographical_order_more_patches_imagnet64_patches_6_30Images}
\label{fig:subfig2}}
\subfloat[Subfigure 3 list of figures text][Cifar10]{
  	  	\includegraphics[width=0.3\linewidth]{figures/topographical_order_more_patches_cifar10_patches_6_30images}
\label{fig:subfig3}}
\caption{An example of whitened dictionary  $\mathcal{D}$ from ImageNet-128 (Left), \Edouard{ ImageNet-64 (Top-Right), CIFAR-10 (Bottom-Right). The atoms have been reordered via a topographic algorithm.}}
\label{dico}
\end{figure}
